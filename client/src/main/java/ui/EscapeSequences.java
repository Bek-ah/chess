...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_PURPLE = SET_TEXT_COLOR + "111m";
    public static final String SET_TEXT_COLOR_WHITE = SET_TEXT_COLOR + "15m";
    public static final String RESET_TEXT_COLOR = UNICODE_ESCAPE + "[39m";

    public static final String SET_BG_COLOR_DARK_TILE = SET_BG_COLOR + "59m";
    public static final String SET_BG_COLOR_LIGHT_TILE = SET_BG_COLOR + "102m";
    ...
    public static final String SET_BG_COLOR_LIGHT_WHITE = SET_BG_COLOR + "252m";
